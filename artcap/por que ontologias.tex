...
\chaptermark{¿Por qué ontologías políticas?}
\Author{Gala Aznarez Carin et al.} % para el encabezado decidí, dado que son mucho autores, colocar al primero seguido de la expresión "et al".
	% encabezado para autor
	\begin{center}
		\nombreautor{Gala Aznarez Carini, Emmanuel Biset, Andrés Daín, Roque Farrán, Daniel Groisman, Manuel Moyano, Juan Manuel Reynares, Aurora Romero, Mercedes Vargas}\\[1ex]
		\makebox[2pc]{\dotfill}
	\end{center} % acá decidí colocar a todos los autores firmantes y darle un centrado
...
\vspace{1em} % para el tratamiento de la argumentación de esta sección de las premiliminares, usé este marcado ya que si colocaba el número en negritas heredaba la configuración del texto de párrafo y aparecía con sangría. Vi también que se podía colocar "\section*{1}" pero puede no ser lo más indicado. Corríjame si me equivoco.
\noindent\textbf{1}
...
\ifPDF
\separata{¿Por qué ontologías políticas}
\fi
